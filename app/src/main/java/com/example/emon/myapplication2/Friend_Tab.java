...
public class Friend_Tab extends AppCompatActivity {
    private RecyclerView request_list;
    private FirebaseDatabase mDatabase;
    private DatabaseReference mReference,mFriend_Ref,mReceiverRef,existRef;
    ImageView iv_search;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finish();
        startActivity(new Intent(Friend_Tab.this,Welcome.class));
                                        ...
                                        mFriend_Ref.child(friend_key).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                                                    @Override
                                                    public void onClick(View view) {
                                                        Intent friend_intent=new Intent(Friend_Tab.this,Friend_Profile_Activity.class);
